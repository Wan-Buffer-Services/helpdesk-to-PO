...
def post_init_hook(env):
    """
    Forcefully add the 'PO Generated' stage to all existing Helpdesk Teams
    to ensure consistent sorting and visibility.
    """
    # Retrieve the stage by its XML ID
    stage = env.ref('wb_ticket_PO.stage_po_generated', raise_if_not_found=False)
    if not stage:
        return
    ...
    # Target stages to place 'PO Generated' BEFORE
    ...
    for team in teams:
        ...
        # If PO Generated is not in the list, add it
